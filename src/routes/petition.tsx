        ...
        <div className="antialiased font-sans selection:bg-white selection:text-zinc-900 overflow-x-hidden bg-[#18181b] text-white min-h-screen">
            ...
            <main className="relative w-full min-h-screen pt-[136px] px-6 md:px-12 lg:px-24 max-w-[1920px] mx-auto">
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-12 relative z-10">
                    ...
                    {/* Left Column: Form */}
                    <div className="w-full lg:w-2/3 pt-12 lg:pt-20 pb-24 text-left">
                        {/* <div className="mb-12">
                            <h2
                    ...
                    <div className="w-full lg:w-1/3 md:min-h-full border-b lg:h-[calc(100vh-6rem)] lg:sticky lg:top-[136px] flex flex-col justify-center items-start border-t lg:border-t-0 lg:border-l border-zinc-800 pt-12 lg:pt-0 lg:pl-0">
